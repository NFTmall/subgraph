...
export class NFTmallERC721__getRoyaltiesResultValue0Struct extends ethereum.Tuple {
  get account(): Address {
    return this[0].toAddress();
  }
...
export class NFTmallERC721 extends ethereum.SmartContract {
  ...
  getRoyalties(
    id: BigInt
  ): Array<NFTmallERC721__getRoyaltiesResultValue0Struct> {
    ...
    return result[0].toTupleArray<
      NFTmallERC721__getRoyaltiesResultValue0Struct
    >();
  }

  try_getRoyalties(
    id: BigInt
  ): ethereum.CallResult<Array<NFTmallERC721__getRoyaltiesResultValue0Struct>> {
    let result = super.tryCall(
      "getRoyalties",
      "getRoyalties(uint256):((address,uint256)[])",
      [ethereum.Value.fromUnsignedBigInt(id)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<NFTmallERC721__getRoyaltiesResultValue0Struct>()
    );
  }
